// Level 1 Phonics Data — 20 Sound Groups
// This file contains raw group definitions only.
// Auto-generation from images happens in phonicsData.js at load time.

const LEVEL1_GROUPS = [
  {
    id: 1, title: "Group 1", sounds: ["s", "a", "t", "i", "p", "n"],
    color: "#FF6B9D", icon: "🎀",
    words: [
  ...
  {
    id: 2, title: "Group 2", sounds: ["c", "k", "e", "h", "r", "m", "d"],
    color: "#4ECDC4", icon: "🐔",
    words: [
  ...
  {
    id: 3, title: "Group 3", sounds: ["g", "o", "u", "l", "f", "b"],
    color: "#FFE66D", icon: "🐕",
    words: [
  ...
  {
    id: 4, title: "Group 4", sounds: ["ai", "ay", "a-e"], subtitle: "Long Vowel A",
    color: "#FF8A5B", icon: "🎂",
    words: [
  ...
  {
    id: 5, title: "Group 5", sounds: ["j"], color: "#9B59B6", icon: "🍯",
    words: [
  ...
  {
    id: 6, title: "Group 6", sounds: ["oa", "ow", "o-e"], subtitle: "Long Vowel O",
    color: "#3498DB", icon: "🐐",
    words: [
  ...
  {
    id: 7, title: "Group 7", sounds: ["ie", "y", "igh", "i-e"], subtitle: "Long Vowel I",
    color: "#E74C3C", icon: "🚲",
    words: [
  ...
  {
    id: 8, title: "Group 8", sounds: ["ee", "ea", "e-e"], subtitle: "Long Vowel E",
    color: "#2ECC71", icon: "👣",
    words: [
  ...
  {
    id: 9, title: "Group 9", sounds: ["or", "al", "au", "aw"], color: "#F39C12", icon: "⚖️",
    words: [
  ...
  {
    id: 10, title: "Group 10", sounds: ["z", "w", "ng"], color: "#1ABC9C", icon: "⭐",
    words: [
  ...
  {
    id: 11, title: "Group 11", sounds: ["oo", "ooo"], subtitle: "Short & Long OO",
    color: "#8E44AD", icon: "👑",
    words: [
  ...
  {
    id: 12, title: "Group 12", sounds: ["v", "y", "x"], color: "#27AE60", icon: "📚",
    words: [
  ...
  {
    id: 13, title: "Group 13", sounds: ["ch", "sh"], color: "#E67E22", icon: "📦",
    words: [
  ...
  {
    id: 14, title: "Group 14", sounds: ["th", "thh"], color: "#16A085", icon: "🐚",
    words: [
  ...
  {
    id: 15, title: "Group 15", sounds: ["qu"], color: "#D35400", icon: "👸",
    words: [
  ...
  {
    id: 16, title: "Group 16", sounds: ["ou", "ow"], color: "#C0392B", icon: "🦉",
    words: [
  ...
  {
    id: 17, title: "Group 17", sounds: ["oi", "oy"], color: "#7F8C8D", icon: "🧸",
    words: [
  ...
  {
    id: 18, title: "Group 18", sounds: ["ue", "ew", "u-e"], subtitle: "Long Vowel U",
    color: "#2980B9", icon: "✈️",
    words: [
  ...
  {
    id: 19, title: "Group 19", sounds: ["er", "ir", "ur"], color: "#9B59B6", icon: "🐦",
    words: [
  ...
  {
    id: 20, title: "Group 20", sounds: ["ar"], color: "#E74C3C", icon: "🚗",
    words: [
