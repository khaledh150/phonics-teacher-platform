      ...
      <div className="flex-1 flex flex-col items-center justify-center gap-6 md:gap-8 p-4">
        ...
        {round && (
          <motion.div
            ...
            style={{
              width: 'clamp(200px, min(55vmin, 50vh), 400px)',
              height: 'clamp(200px, min(55vmin, 50vh), 400px)',
            ...
            {round.choices.map((choice, idx) => {
              ...
              return (
                <motion.div
                  ...
                  style={{
                    width: 'clamp(100px, min(25vmin, 22vh), 180px)',
                    height: 'clamp(100px, min(25vmin, 22vh), 180px)',
