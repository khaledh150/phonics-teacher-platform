  ...
  return (
    <div className="h-screen w-screen flex flex-col bg-gradient-to-b from-[#1a1147] to-[#6B3FA0] overflow-hidden">
      ...
      {gameComplete && (
        <GameResultCard
          title="Spin Champion!"
          subtitle="You got them all right!"
          accentColor="#EF4444"
          icon={RotateCw}
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-4 gap-4">
        {/* Wheel container */}
        <div className="relative" style={{ width: 'min(75vw, 50vh, 380px)', height: 'min(75vw, 50vh, 380px)' }}>
          ...
          >
            ...
            {wheelSounds.map((sound, i) => {
              ...
              return (
                ...
                >
                  {getDisplaySound(sound).toUpperCase()}
                </div>
              );
            })}
          ...
          >
            {choices.map((word) => {
              ...
              return (
                ...
                >
                  <div
                    className="rounded-2xl bg-white flex items-center justify-center p-2 overflow-hidden"
                    style={{ width: 'clamp(90px, min(22vw, 18vh), 160px)', height: 'clamp(90px, min(22vw, 18vh), 160px)' }}
                    style={{
