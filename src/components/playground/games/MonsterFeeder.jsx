    ...
    >
      <div
        ...
        style={{
          ...
          minWidth: 'clamp(90px, min(22vw, 28vh), 170px)',
        }}
      >
...
const MonsterFeederGame = ({ group, onBack, onPlayAgain }) => {
  ...
  if (gameComplete) {
    return (
      <div className="h-screen w-screen flex flex-col items-center justify-center bg-gradient-to-b from-[#1a1147] to-[#FF6B9D]">
        <GameResultCard
          title="Monster Satisfied!"
          subtitle="You fed all the right words!"
          accentColor="#FF6B9D"
          icon={Ghost}
  ...
  return (
    <div className="h-screen w-screen overflow-hidden relative flex flex-col bg-gradient-to-b from-[#1a1147] to-[#6B3FA0]">
      ...
      <div className="relative z-30 flex items-center justify-center gap-3 md:gap-5 pb-8 md:pb-10 landscape:pb-6 pt-2 px-2">
        <AnimatePresence>
