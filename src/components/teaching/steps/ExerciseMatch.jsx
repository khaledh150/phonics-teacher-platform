  ...
  return (
    <div className="h-full w-full flex flex-col items-center relative overflow-hidden">
      ...
      <div className="flex-1 w-full flex flex-col landscape:flex-row items-center justify-center px-3 md:px-6 lg:px-10 py-1 md:py-2 lg:py-4 gap-2 landscape:gap-2 md:gap-4 lg:gap-5">
        ...
        {/* Separator — horizontal line in portrait, vertical in landscape */}
        <div className="landscape:hidden w-full max-w-md lg:max-w-2xl flex items-center gap-3 my-0">
          <div className="flex-1 h-px bg-[#3e366b]/10" />
          <span className="text-white/30 text-xs font-medium">match</span>
          <div className="flex-1 h-px bg-[#3e366b]/10" />
        </div>
        <div className="hidden landscape:flex flex-col items-center gap-2 h-full max-h-48 self-center">
          <div className="flex-1 w-px bg-[#3e366b]/10" />
          <span className="text-white/30 text-xs font-medium rotate-90 whitespace-nowrap">match</span>
          <div className="flex-1 w-px bg-[#3e366b]/10" />
        </div>
